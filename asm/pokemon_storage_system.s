...
._1921:
	...
	ldrb	r0, [r0, #0x5]
	cmp	r0, #0x1
	beq	._1925	@cond_branch
	cmp	r0, #0x1
	bgt	._1926	@cond_branch
	cmp	r0, #0
	beq	._1927	@cond_branch
	b	._1943
._1930:
	.align	2, 0
._1929:
...
._1926:
	cmp	r0, #0x2
	beq	._1931	@cond_branch
	b	._1943
._1925:
	cmp	r1, #0
	beq	._1943	@cond_branch
	mov	r0, #0x1
	bl	sub_809CDEC
	b	._1944
._1927:
...
._1931:
	...
	ldrb	r0, [r0]
	cmp	r0, #0
	beq	._1937	@cond_branch
	cmp	r1, #0
	beq	._1938	@cond_branch
	mov	r0, #0x4
	bl	sub_809CDEC
	b	._1944
._1941:
...
._1944:
	...
	ldrb	r0, [r0, #0x5]
	cmp	r0, #0x2
	bne	._1948	@cond_branch
	ldr	r0, ._1949 + 4
	ldrb	r0, [r0]
	lsl	r0, r0, #0x18
	asr	r0, r0, #0x18
	cmp	r0, #0
	bne	._1947	@cond_branch
	mov	r0, #0x2
	bl	sub_809CDEC
	b	._1948
._1950:
